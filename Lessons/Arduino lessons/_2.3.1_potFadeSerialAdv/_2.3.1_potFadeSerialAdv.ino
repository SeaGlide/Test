...
int outputValue = 0;            // variable used to store the brightness value of the LED 0-255
...
void loop() {                             // start main loop 
  ...
  Serial.print(sensorValue, BIN);              // print the sensorValue (0-1023)
  Serial.print("\t Output Value: ");         // print "Sensor Value: " to the Serial console
  Serial.print(outputValue, BIN);              // print the sensorValue (0-1023)
